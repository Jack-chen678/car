#ifndef NO_MCU_GANV_GRAYSCALE_H_
#define NO_MCU_GANV_GRAYSCALE_H_
#include <string.h>
#include "MyDefine.h"
/**************************** 传感器版本配置 ****************************/
#define Class		    0
...
/*************************** 硬件抽象层配置 ****************************/
// GPIO地址切换宏定义
#define Switch_Address_0(i) ((i)?(HAL_GPIO_WritePin(GPIOG, GPIO_PIN_5,GPIO_PIN_SET)) : (HAL_GPIO_WritePin(GPIOG, GPIO_PIN_5,GPIO_PIN_RESET)))// 地址位0控制

#define Switch_Address_1(i) ((i)?(HAL_GPIO_WritePin(GPIOG, GPIO_PIN_6,GPIO_PIN_SET)) : (HAL_GPIO_WritePin(GPIOG, GPIO_PIN_6,GPIO_PIN_RESET)))// 地址位1控制

#define Switch_Address_2(i) ((i)?(HAL_GPIO_WritePin(GPIOG, GPIO_PIN_7,GPIO_PIN_SET)) : (HAL_GPIO_WritePin(GPIOG, GPIO_PIN_7,GPIO_PIN_RESET)))// 地址位2控制
