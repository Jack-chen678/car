...
static ebtn_btn_t static_buttons[] = {
        EBTN_BUTTON_INIT(USER_BUTTON_1, &defaul_ebtn_param),// KEY1, ID=1, 使用 'key_param_normal' 参数
        EBTN_BUTTON_INIT(USER_BUTTON_2, &defaul_ebtn_param),// KEY2, ID=2, 使用 'key_param_normal' 参数
        EBTN_BUTTON_INIT(USER_BUTTON_3, &defaul_ebtn_param),// KEY2, ID=2, 使用 'key_param_normal' 参数
};
